export const projects = [
  ...
  // },
  {
    ...
    image:
      "https://www.techspot.com/images2/news/bigimage/2023/03/2023-03-08-image-5.jpg",
    tags: [
      "Next Js",
      "TypeScript",
      "Tailwind",
...

  {
    ...
    description:
      "Chit-Chat is a messaging platform integrating instant message delivery, end-to-end encryption, and real-time push notifications. Users can share multimedia files, including images, videos, and documents, within group chats. Features include status tracking (online/offline), media sharing, and message synchronization across devices, ensuring seamless communication. Additionally, the app supports multi-platform access and offers a scalable architecture for global user engagement.",
    image:
      "https://mir-s3-cdn-cf.behance.net/project_modules/fs/1495df42839031.57d97c130a355.jpg",
    tags: [
      "MongoDb",
      "Express",
      "React",
  ...
  //   ],
  //   category: "NEXT",
  //   github: "https://github.com/pradyotsrivastava/spotify-clone",
  //   webapp: "",
  // },
